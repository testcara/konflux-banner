...
- ✅ [PR #5](https://github.com/testcara/konflux-banner/pull/7) - Vaild Example 3: new valid banner content for new clusters
...
- ❌ [PR #3](https://github.com/testcara/konflux-banner/pull/8) – Invalid Example 3: invalid new banner content without updating the deploy real content.
